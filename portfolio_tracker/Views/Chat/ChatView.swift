...
struct ChatView: View {
    ...
    private var chatHeader: some View {
        HStack {
            ...
            // Reasoning toggle
            Toggle(isOn: $viewModel.showReasoning) {
                Image(systemName: viewModel.showReasoning ? "brain.head.profile.fill" : "brain.head.profile")
            }
            .toggleStyle(.button)
            .help(viewModel.showReasoning ? "显示思考过程" : "隐藏思考过程")
